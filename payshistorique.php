                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Liste des Pays</strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    <thead>
                     ...
                     <?php
                     require_once(__DIR__.'/service/PaysService.php');
                                            require_once 'C:\xampp\htdocs\newtemp\service\PaysService.php';
                                     $es = new PaysService();
                             ...
                             <tr>
                            <tr>
                                    <td><?php echo $e->getidPays(); ?></td>
                                    <td><?php echo $e->getnomPays(); ?></td>
                              
                                    <td> 
                                    <a type="button" class="btn btn-outline-danger btn-sm btn-block" href="controller/DeletePays.php?id=<?php echo $e->getidPays(); ?>">Supprimer</td></a>
                            </td>
