...
require_once RACINE.'/service/UsrService.php';
//echo $_SESSION['id'];
if($_SESSION['id']!=78)
{
      ...
      <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div id="main-menu" class="main-menu collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="menu-item-has-children dropdown">
              ...
              <ul class="sub-menu children dropdown-menu">
                <li>
                  ...
                  <a href="userhistorique.php">Consulter Utilisateurs
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item-has-children dropdown">
              ...
              <ul class="sub-menu children dropdown-menu">
                <li>
                  ...
                  <a href="ajouterville.php">Ajouter Ville
                  </a>
                </li>
                <li>
                  <i class="fa fa-search">
                  </i>
                  <a href="villehistorique.php">consulter les Villes
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item-has-children dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> 
                <i class="menu-icon fa fa-map-marker">
                </i>Pays
              </a>
              <ul class="sub-menu children dropdown-menu">
                <li>
                  <i class="menu-icon fa fa-plus-square-o">
                  </i>
                  <a href="ajouterpays.php">Ajouter Pays
                  </a>
                </li>
                <li>
                  <i class="menu-icon fa fa-search">
                  </i>
                  <a href="payshistorique.php">Consulter les Pays
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item-has-children dropdown">
              ...
              <ul class="sub-menu children dropdown-menu">
                <li>
                  ...
                  <a href="trajethistorique.php">Consulter les Trajets
                  </a>
                </li>
              </ul>
            </li>
