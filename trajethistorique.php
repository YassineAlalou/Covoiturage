                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Liste des Trajets</strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <?php
                                            ...
                                            require_once 'C:\xampp\htdocs\newtemp\service\TrajetService.php';
                    ...
                    if($e->getidUser()!= 78){ ?>                               
                      <tr>
                        ...
                        <td><a  href="/newtemp/PageProfile.php?id=<?php echo $e->getidUser();  ?>" ><?php echo $e->getidUser(); ?></a> </td>
                        <td><?php  if ($e->getroute()==1) echo "Regionale";
                                    if ($e->getroute()==2) echo "AutoRoute";
                                    if ($e->getroute()==3) echo "Nationale";?></td>
                        <td><?php echo $e->getheurDepart(); ?></td>
                        <td><?php echo $e->getnbrplaces(); ?></td>
                        <td><?php echo $e->getcommentaire(); ?></td>

                        <td> 
                                    <a type="button" class="btn btn-outline-danger btn-sm btn-block" href="controller/DeleteTrajet.php?id=<?php echo $e->getcodeTrajet(); ?>">Supprimer</a>
                            </td>
                        <td>
