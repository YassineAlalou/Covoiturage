...
<body>
    ...
    <div  id="right-panel" class="right-panel">
       ...
       <form method="POST" action="searchtrajet.php">
        <div class="card">
            <div class="card-header bg-dark">
            <strong class="card-title text-light">Recherche trajet :
            </strong> 
            </div>
            <div class="card-boy">
            </br>
            ...
            <div class="col-10">
                ...
                <label for="city" class=" form-control-label offset-4">Ville Depart
                </label>
                <input type="text" id="cityD" name="depart" placeholder="Entrer Votre Ville Depart" class="form-control">
                </div>
            </div>
            </div>
            <div class="col-6">
            <div class="col-10">
                <div class="form-group">
                <label for="city" class=" form-control-label offset-4">Ville Destination
                </label>
                <input type="text" id="cityA" name="destination" placeholder="Entrer Votre Destination" class="form-control">
                </div>
            </div>
            </div>
        </div>
        <div class="col col-md-7 offset-2">
            ...
            <div class="col col-md-7">
                <label for="text-input" class=" form-control-label offset-8">Date Depart
                </label>
            </div>
            <div class="col-12 col-md-12">
                <input type="date" name="dateTrajet" id="text-input" placeholder="" class="form-control">
            </div>
            </div>
        </div>
        <!-- .content -->
