                ...
                <div class="col-md-12">
                  ...
                  <?php
                      ...
                      <tr>
                        ...
                        <td> 
                            <a type="button" class="btn btn-outline-danger btn-sm btn-block" href="controller/DeleteUser.php?id=<?php echo $e->getId(); ?>">Supprimer</td></a>
                        </td>
