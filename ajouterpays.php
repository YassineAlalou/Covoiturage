                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title" v-if="headerText">Ajouter Un Pays </strong>
                                </div>
                                <form action="/newtemp/controller/AddPays.php" method="POST">
                                <div class="card-body">
                           
                                    <div class="form-group">
                                    <strong class="card-title">Nom du pays </strong>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-map-marker"></i></div>
                                        <input class="form-control" name="nomPays">
                                    </div>
                                    <small class="form-text text-muted">Taper le nom du pays</small>
                                    </div>
