                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title" v-if="headerText">Ajouter Une Ville </strong>
                                </div>
                                 <form action="/newtemp/controller/AddVille.php" method="POST">
                                <div class="card-body">
                                ...
                                <strong class="card-title">Sélectionner le Pays </strong>
                       
                            <div class="card-body">

                                  <select data-placeholder="Choisir un Pays..."  class="form-control"  name="idPays">
                                    <?php 
                                    ...
                                    <div class="card-body">
                                    <strong class="card-title">Nom de la Ville </strong>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-home"></i></div>
                                        <input class="form-control" name="nomVille">
                                    </div>
                                    <small class="form-text text-muted">Taper le nom de la ville</small>
                                    </div>
                                 ...
                                 <div class="card-footer">
                                    ...
                                    <button type="reset" class="btn btn-outline-danger btn-lg btn-block">Annuler</button>
