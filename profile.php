...
if($isActif->getActif()==0){?>
              <div class="sufee-alert alert with-close alert-warning alert-dismissible fade show">
                <span class="badge badge-pill badge-warning">Alert
                </span>
...
echo "XXX-XXX-XXXXXX";
            ...
            <div class="card-footer">
              <center>
                <?php if($isActif->getActif()==0){?>
                <button type="button" class="btn btn-secondary btn-lg btn-block" disabled data-toggle="modal" data-target="#mediumModal">
                  Edit
                </button>
                <?php } else { ?>
                <button type="button" class="btn btn-success btn-lg btn-block" enabled data-toggle="modal" data-target="#mediumModal">
                  Edit
                </button>
                <?php } ?>
              </center>
