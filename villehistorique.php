                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    <thead>
                     ...
                     <?php
                                            ...
                                            require_once(__DIR__.'/service/VilleService.php');
                                            require_once 'C:\xampp\htdocs\newtemp\service\VilleService.php';
                                $es = new VilleService();
                             ...
                             <tr>
                        <tr>
                                    <td><?php echo $e->getidville(); ?></td>
                                    <td><?php echo $e->getNomVille(); ?></td>
                                    <td><?php if ($e->getidPays()==14)echo "Maroc";if ($e->getidPays()==15)echo "France" ?></td>

                                    <td>
                                    <a type="button" class="btn btn-outline-danger btn-sm btn-block" href="controller/DeleteVille.php?id=<?php echo $e->getidVille(); ?>">Supprimer</td></a>
                                    </td>
